# Data Definitions Contributor License Agreement (DCLA)
...
* **Project** - is an umbrella term that refers to any and all Data Definitions projects.
...
verbal communication with CORS GmbH, instride AG, contributors or maintainers.
...
Subject to the terms and conditions of this agreement, You grant to the Projects' maintainers, contributors, users and
to CORS GmbH and instride AG a perpetual, worldwide, non-exclusive, no-charge, royalty-free, irrevocable (except as stated in this section)
...
For questions about this Contributor License Agreement, please contact:
