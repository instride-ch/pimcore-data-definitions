...
class Dao extends Model\Dao\PhpArrayTable
{
    ...
    public function save()
    {
        ...
        try {
            ...
            $data = [];
            $allowedProperties = ['id', 'name', 'provider', 'class', 'providerConfiguration', 'creationDate', 'modificationDate', 'mapping', 'objectPath', 'cleaner', 'key', 'renameExistingObjects', 'relocateExistingObjects', 'filter', 'runner'];
