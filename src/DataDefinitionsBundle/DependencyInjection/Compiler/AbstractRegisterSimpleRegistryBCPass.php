...
abstract class AbstractRegisterSimpleRegistryBCPass implements CompilerPassInterface
{
    /**
     * @var string
     */
    ...
    /**
     * RegisterSimpleRegistryBCPass constructor.
     ...
     * @param string $bcTag
     */
    public function __construct(string $registry, string $parameter, string $tag, string $bcParameter, string $bcTag)
    {
