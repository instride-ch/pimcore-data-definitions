...
final class StoreValuesSetterType extends AbstractType
{
...
class_alias(StoreValuesSetterType::class, 'ImportDefinitionsBundle\Form\Type\Setter\CoreShop\StoreValuesSetterType');
