...
class DefaultValueInterpreter implements InterpreterInterface, DataSetAwareInterface
{
...
class_alias(DefaultValueInterpreter::class, 'ImportDefinitionsBundle\Interpreter\DefaultValueInterpreter');
