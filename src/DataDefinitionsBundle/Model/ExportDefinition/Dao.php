...
class Dao extends Model\Dao\PhpArrayTable
{
    ...
    public function getById($id = null)
    {
        ...
        if (isset($data['id'])) {
            ...
            throw new \InvalidArgumentException(sprintf('Export Definition with id: %s does not exist', $this->model->getId()));
        }
    }
...
class_alias(Dao::class, 'ImportDefinitionsBundle\Model\ExportDefinition\Dao');
