...
namespace WVision\Bundle\DataDefinitionsBundle\Model\ImportDefinition\Listing;
...
class_alias(Dao::class, 'ImportDefinitionsBundle\Model\ImportDefinition\Listing\Dao');
