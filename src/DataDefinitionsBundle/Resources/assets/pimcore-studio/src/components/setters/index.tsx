/**
 * Setter Configuration Components
 *
 * Dynamically renders the appropriate config panel based on setter type.
...
export interface SetterConfigProps {
  type: string
...
export const SetterConfig: React.FC<SetterConfigProps> = (props) => {
  const registry = container.get<ConfigRegistry<SetterConfigProps>>(
    dataDefinitionsServiceIds.setterConfigRegistry
  )
