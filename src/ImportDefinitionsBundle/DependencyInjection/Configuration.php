                ...
                ->children()
                    ->arrayNode('js')
                        ...
                        ->children()
                            ...
                            ->scalarNode('import_provider_abstract')->defaultValue('/bundles/importdefinitions/pimcore/js/import_provider/abstractprovider.js')->end()
                            ->scalarNode('import_provider_csv')->defaultValue('/bundles/importdefinitions/pimcore/js/import_provider/csv.js')->end()
                            ->scalarNode('import_provider_sql')->defaultValue('/bundles/importdefinitions/pimcore/js/import_provider/sql.js')->end()
                            ->scalarNode('import_provider_external_sql')->defaultValue('/bundles/importdefinitions/pimcore/js/import_provider/externalSql.js')->end()
                            ->scalarNode('import_provider_json')->defaultValue('/bundles/importdefinitions/pimcore/js/import_provider/json.js')->end()
                            ->scalarNode('import_provider_xml')->defaultValue('/bundles/importdefinitions/pimcore/js/import_provider/xml.js')->end()
                            ...
                            ->scalarNode('provider_abstract')->defaultValue('/bundles/importdefinitions/pimcore/js/import_provider/abstractprovider.js')->end()
                            ->scalarNode('provider_csv')->defaultValue('/bundles/importdefinitions/pimcore/js/import_provider/csv.js')->end()
                            ->scalarNode('provider_sql')->defaultValue('/bundles/importdefinitions/pimcore/js/import_provider/sql.js')->end()
                            ->scalarNode('provider_external_sql')->defaultValue('/bundles/importdefinitions/pimcore/js/import_provider/externalSql.js')->end()
                            ->scalarNode('provider_json')->defaultValue('/bundles/importdefinitions/pimcore/js/import_provider/json.js')->end()
                            ->scalarNode('provider_xml')->defaultValue('/bundles/importdefinitions/pimcore/js/import_provider/xml.js')->end()
                            ->scalarNode('provider_raw')->defaultValue('/bundles/importdefinitions/pimcore/js/import_provider/raw.js')->end()
