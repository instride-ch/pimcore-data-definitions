...
class ImportDefinitionsExtension extends AbstractModelExtension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        if (array_key_exists('ProcessManagerBundle', $bundles)) {
            $config['pimcore_admin']['js']['process_manager_import_definitions'] = '/bundles/importdefinitions/pimcore/js/process_manager/import_definitions.js';
            $config['pimcore_admin']['js']['process_manager_export_definitions'] = '/bundles/importdefinitions/pimcore/js/process_manager/export_definitions.js';
