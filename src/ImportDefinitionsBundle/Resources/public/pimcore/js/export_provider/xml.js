...
pimcore.plugin.importdefinitions.export_provider.xml = Class.create(pimcore.plugin.importdefinitions.export_provider.abstractprovider, {
    getItems : function () {
        return [{
            xtype: 'textfield',
            name: 'xsltPath',
            fieldLabel: t('importdefinitions_xml_xslt_path'),
