...
pimcore.registerNS('pimcore.plugin.importdefinitions.import_provider.csv');

pimcore.plugin.importdefinitions.import_provider.csv = Class.create(pimcore.plugin.importdefinitions.import_provider.abstractprovider, {
    getItems : function () {
        return [{
            xtype: 'textfield',
            name: 'delimiter',
